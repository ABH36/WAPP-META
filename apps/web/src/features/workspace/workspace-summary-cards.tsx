 ...
 * No `href` is set on any card: `/billing` and `/crm` don't exist yet as
 * routes in this app (their own FRD volumes haven't shipped) — linking to
 * them now would 404. Cards render as informational widgets only until
 * those volumes land and can wire the link target themselves.
 */
